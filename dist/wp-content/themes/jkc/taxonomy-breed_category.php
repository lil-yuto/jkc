              ...
              <div class="c-card-item-style-horizontal__contents-wrapper">
                ...
                <div class="c-card-item-style-horizontal__content">
                  <div class="c-card-item-style-horizontal__description">
                    <p><span class="u-bold u-color-accent-green">スタンダードNo</span>：<?php echo get_field('acf_wd_fci'); ?></p>
                    <p><span class="u-bold u-color-accent-green">原産地</span>：<?php echo get_field('acf_wd_place'); ?></p>
                    <p class="max-1row"><span class="u-bold u-color-accent-green">用途</span>&emsp;：<?php echo get_field('acf_wd_use'); ?></p>
                    <p class="max-1row"><span class="u-bold u-color-accent-green">沿革</span>&emsp;：<?php echo get_field('acf_wd_history'); ?></p>
                  </div>
